public class UsageMessage {
    public static final String message = "usage: App [-d <propertyPath> | -t <textPath> | -td <textPath propertyPath> | -tx <textPath xmlPath> | -x <xmlPath>]\r\n" +
            ...
            "                                to the database.Reads the database. Extracts the facts from the rules and deduce them.\r\n" +
            " -t,--text <textPath>           Argument is a path of text file, which contains rules and facts. Extracts the facts from\r\n" +
            ...
            "                                xml file.\r\n" +
            " -x,--xml <xmlPath>             Argument is a path of xml file, which contains rules and facts. Extracts the facts from\r\n" +
            "                                the rules and deduce them.\r\n";
}
